          ...
          <div key={type} className="bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            <div>
              {group.length === 0 ? (
                ...
                group.map(meal => (
                  <div key={meal.id} className="px-4 py-3 hover:bg-gray-50 border-b border-gray-50 last:border-0">
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-gray-800 font-medium truncate">{meal.name}</p>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <button onClick={() => handleDelete(meal.id)} className="text-gray-300 hover:text-red-400 transition-colors">
